      ...
      <div className="about-content">
        ...
        <div className="about-details">
          <div className="about-current-role standout-card">
            <h3>Current Role</h3>
            <p>
              I work remotely as a Data Engineer. Most of my days are spent working with PySpark, Databricks, SQL, ADF Azure tools, and Power BI—helping teams solve real-world problems with data.
            </p>
          </div>
